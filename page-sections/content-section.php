...
>
    <div class="container style--<?php echo $content_section_style; ?>">
        ...
        <div class="content-section__text">
            <!-- Header -->
            <?php if ( $header ) : ?>
                <<?php echo esc_attr( $header_style ); ?> class="content-section__header font--<?php echo esc_attr($font_colour) ?>">
            ...
            <!-- WYSIWYG -->
            <?php if ( $wysiwyg_text ) : ?>
                <div class="content-section__wysiwyg font--<?php echo esc_attr($font_colour) ?>">
