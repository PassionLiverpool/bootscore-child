...
>
    <div class="container background--<?php echo $background_colour ?>" style="<?php if($background_image):?>background-image: url('<?php echo $background_image['url'] ?>');<?endif;?>">
        ...
        <div class="callout-section__text">
            <!-- Header -->
            <?php if ( $header ) : ?>
                <<?php echo esc_attr( $header_style ); ?> class="callout-section__header font--<?php echo esc_attr($font_colour) ?>">
            ...
            <!-- WYSIWYG -->
            <?php if ( $wysiwyg_text ) : ?>
                <div class="callout-section__wysiwyg font--<?php echo esc_attr($font_colour) ?>">
